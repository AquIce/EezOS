...
[BITS 16] ; This bootloader is a 16 bits system
[ORG 0x7C00] ; Origin, tell the assembler that where the code will be in memory after it is loaded

MOV SI, Welcome_String ; Store welcome string pointer to SI
CALL _Video_Mode
...
_PrintString:; Procedure to print a string on the screen
...
; Datas
Welcome_String db 'Welcome to EezOS...', 0 ; A string which ends with 0
